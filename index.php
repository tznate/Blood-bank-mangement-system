...
<body>
    <div id="full">
        <div id="inner_full">
        <div id="header"><h2><a href="admin-home.php" style="text-decoration: none; color: white"> Blood Bank Management
System </a></h2></div>
            ...
            <table align="center">
                ...
                <div id="footer"><h4 align="center">Created by Roll no: 42|47|51|64</h4></div>
